...
# 1.1 Write a program that has two variables: base and height for a rectangle
# base is 10, height is 4
# Print the area of the rectangle. It should print like this: 'The area of rectangle of 10 and 4 is 40'

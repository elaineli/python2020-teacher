...
y = -100
# create tree trunk
create_rectangle(oogway, "chocolate", -15, y-60, 30, 60)

# create presents
create_rectangle(oogway, "orange", -100, y-60, 60, 40)
create_rectangle(oogway, "gold", 50, y-70, 70, 50)
create_rectangle(oogway, "magenta", 150, y-120, 80, 80)
create_rectangle(oogway, "lime", -50, y-130, 60, 60)
create_circle(oogway, 50, y-160, 50 , "orange red")
create_rectangle(oogway, "blue violet", -160, y-180, 100, 100)
...
for _ in range(10):
    oogway.penup()
    oogway.goto(randint(-60,60), randint(-100,10))
    for i in range(5):
        oogway.pendown()
        oogway.forward(5)
        oogway.right(144)
...
for _ in range(10):
    oogway.penup()
    oogway.goto(randint(-20,20), randint(-20,80))
    for i in range(5):
        oogway.pendown()
        oogway.forward(5)
        oogway.right(144)
...
oogway.speed(1)
oogway.penup()
msg = "Merry Christmas From Brandon"
oogway.goto(0, -350)  # y is in minus because tree trunk was below x axis
oogway.color("white")
oogway.pendown()
oogway.write(msg, move=False, align="center", font=("Arial", 25, "bold"))
oogway.penup()
oogway.left(10000)
oogway.hideturtle()
